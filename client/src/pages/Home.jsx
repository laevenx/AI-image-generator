        ...
        <div>
            <h1 className='font-extrabold text-[#222328] text-[32px]'>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
                    Browse through a collection of imaginative and visually stunning images based on DALL-E AI
                </p>    
            </h1>
        </div>

            <div className='mt-16'>
                <FormFile labelName="search posts" type="text" name="text" placeholder="search posts" value={searchText}> </FormFile>
            </div>
